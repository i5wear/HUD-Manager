...
public class HudManager {
    ...
    public Matrix3x2f apply(Matrix3x2fc original) { return original.get(new Matrix3x2f()).translate(OffsetX, OffsetY).scale(Resizer); }

    public Matrix3x2f reset(Matrix3x2fc original) { return original.get(new Matrix3x2f()).scale(1.0f / Resizer).translate(-OffsetX, -OffsetY); }
