...
public class HudManagerScreen extends OptionsSubScreen {
    ...
    @Override protected void addOptions() {
        ...
        ((EditBox) widgets.getLast()).setValue(Float.toString(Target.Resizer));
        ...
        ((EditBox) widgets.getLast()).setValue(Float.toString(Target.Opacity));
        ...
        ((EditBox) widgets.getLast()).setValue(Float.toString(Target.OffsetX));
        ...
        ((EditBox) widgets.getLast()).setValue(Float.toString(Target.OffsetY));
